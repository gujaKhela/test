...
const AddTask = () => {
  ...
  return (
    <>
      ...
      {completedTasks.length?( <div className="absolute left-[420px] top-[26rem]">
        <ul>
        <p className="text-center text-xl font-semibold text-[#34574A]">
          ...
          {completedTasks.map((completedTask) => (
            ...
            >
              <span>
                <div className="font-semibold inline-block line-through">Name</div> -{" "}
                {completedTask.task.input}{" "}
                <span className="ml-4">
                  {" "}
                  <div className="font-semibold inline-block line-through">Date</div> -{" "}
                  {completedTask.task.date}
                </span>
              </span>
            </li>
          ))}
